...
* Before creating bug reports, please check the [existing issues](http://github.com/tterb/Urban-Dictionary-Therapy/issues) as you might find out that one has already been created by another user.
